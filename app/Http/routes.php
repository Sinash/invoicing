...
Route::group(['prefix' => 'admin', 'middleware' => 'auth', 'namespace' => 'Admin'], function() {
    ...
    Route::get('language/reorder', 'LanguageController@getReorder');
	 ...
	 # Excel SAP
    Route::get('excelsap', 'ExcelsapController@index');
    Route::get('excelsap/create', 'ExcelsapController@getCreate');
    Route::post('excelsap/create', 'ExcelsapController@postCreate');
    Route::get('excelsap/{id}/edit', 'ExcelsapController@getEdit');
    Route::post('excelsap/{id}/edit', 'ExcelsapController@postEdit');
    Route::get('excelsap/{id}/delete', 'ExcelsapController@getDelete');
    Route::post('excelsap/{id}/delete', 'ExcelsapController@postDelete');
    Route::get('excelsap/data', 'ExcelsapController@data');
    Route::get('excelsap/reorder', 'ExcelsapController@getReorder');
